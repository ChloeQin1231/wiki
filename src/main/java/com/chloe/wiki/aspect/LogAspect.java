...
public class LogAspect {
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        // 使用 Jackson 的过滤器来排除敏感字段
        SimpleBeanPropertyFilter filter = SimpleBeanPropertyFilter
                .serializeAllExcept("password", "file");
        FilterProvider filters = new SimpleFilterProvider()
                .addFilter("sensitiveFilter", filter);

        LOG.info("请求参数: {}", objectMapper.writer(filters).writeValueAsString(arguments));
    }
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        LOG.info("返回结果: {}", objectMapper.writer(filters).writeValueAsString(result));
